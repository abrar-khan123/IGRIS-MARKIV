# ⚙️ MARK IV
### The Ultimate Cross-Platform Personal AI Assistant — By A_K
...
The assistant is no longer locked to the name "IGRIS". Click `⚙ CUSTOMISE ASSISTANT` in the right panel to change:
...
| Mark | Focus |
|---|---|
| **III** | Instant interrupt · parallel news · two-phase briefing · exponential backoff · vision cooldown |
| **MARK IV** | Auto-start · clipboard intelligence · assistant customization |
| **V** | Wake word · proactive system 2.0 · session memory / daily continuity |
| **VI** | Plugin system · email · quiz mode · calorie counter · and more |
...
```bash
git clone https://github.com/abrar-khan123/IGRIS-MARK-IV-.git
cd Mark-MARK IV
...
Personal and non-commercial use only.BY FATIHMAKES
